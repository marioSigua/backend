...
exports.up = async function (knex) {
  ...
  await knex.schema.createTable(tableNames.subject_reference, function (table) {
    table.string("ref_id", 255).notNullable().primary();
...
exports.down = async function (knex) {
  await knex.schema.dropTableIfExists(tableNames.subject_reference);
